 ...
 */
class Medicines extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('medicine_name, price', 'required'),
			array('medicine_name', 'length', 'max'=>100),
			array('price', 'length', 'max'=>10),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('medicine_id, medicine_name, price', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'transactions' => array(self::HAS_MANY, 'Transactions', 'medicine_id'),
		);
	}
